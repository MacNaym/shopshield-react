...
export function ShopShieldBanner({ shop, onConsent, className }: ShopShieldBannerProps) {
  ...
  // Non renderizzare nulla finché la config non è caricata
  ...
  return (
    <>
      {/* BANNER — visibile solo se consenso non ancora dato */}
      {showBanner && (
        <div style={overlay} className={className}>
          <div style={box}>
            ...
            <div style={actions}>
              <button style={{ flex: 1, padding: 11, border: 'none', borderRadius: 8, fontSize: 13, fontWeight: 700, cursor: 'pointer', background: '#f1f5f9', color: '#08152E' }}
                onClick={() => handleSave(false, false)}>
                Rifiuta tutti
              </button>
              <button style={{ flex: 1, padding: 11, border: 'none', borderRadius: 8, fontSize: 13, fontWeight: 700, cursor: 'pointer', color: 'white', background: primary }}
                onClick={() => handleSave(analytics, marketing)}>
                Salva scelte
              </button>
              <button style={{ flex: 1, padding: 11, border: 'none', borderRadius: 8, fontSize: 13, fontWeight: 700, cursor: 'pointer', color: 'white', background: accent }}
      ...
      {/* TAB — sempre visibile dopo il caricamento */}
      <div style={tab}
        ...
        <div style={{ flexShrink: 0, width: 40, height: 40, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 8px' }}>
          {logoTab
            ? <img src={logoTab} style={{ width: 24, height: 24, display: 'block', borderRadius: 4 }} alt="" />
      ...
      {/* PANNELLO preferenze — sempre accessibile */}
      <div style={panel}>
